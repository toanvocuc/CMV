      ...
      <aside className="w-56 bg-[#0f172a] flex flex-col shrink-0">
        ...
        <div className="px-3 py-4 border-t border-white/10">
          <div className="flex items-center gap-2 px-3 py-2 mb-2">
            <div className="w-7 h-7 rounded-full bg-[#c00000] flex items-center justify-center text-white text-[11px] font-black uppercase">
              {username?.[0] ?? "A"}
            </div>
            <span className="text-white/70 text-[12px] font-medium truncate">{username}</span>
          </div>
